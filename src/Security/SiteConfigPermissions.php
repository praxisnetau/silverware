...
/**
 * Enables CRUD operations on the object if the member can edit site configuration.
 *
 * @package SilverWare\Security
 * @author Colin Tucker <colin@praxis.net.au>
 * @copyright 2017 Praxis Interactive
...
trait SiteConfigPermissions
{
    ...
    {
        return Permission::check('EDIT_SITECONFIG', 'any', $member);
    }
